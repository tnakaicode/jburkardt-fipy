...
def step6 ( my_grid, my_degree, my_p ):

#*****************************************************************************80
#
## step6 tries to solve the p-Laplacian problem directly.
#
#  Discussion:
#
...
#  Plot the mesh.
#
  plot ( my_mesh, title = 'step6 Mesh' )
  filename = 'step6_mesh.png'
...
#  Plot the solution u.
#
  fig = plot ( u, title = 'step6 solution' )
  plt.colorbar ( fig )
  filename = 'step6_solution.png'
  plt.savefig ( filename )
  print ( '  Graphics saved as "%s"' % ( filename ) )
  plt.close ( )
#
...
#
  ...
  fig = plot ( gradun, title = 'step6 |grad u|' )
  plt.colorbar ( fig )
  filename = 'step6_gradun.png'
  plt.savefig ( filename )
  print ( '  Graphics saved as "%s"' % ( filename ) )
  plt.close ( )
#
...
#
  gammau = gamma ( u )
  fig = plot ( gammau, title = 'step6 gamma(u)' )
  plt.colorbar ( fig )
  filename = 'step6_gammau.png'
  plt.savefig ( filename )
  print ( '  Graphics saved as "%s"' % ( filename ) )
  plt.close ( )
#
